...
rowGenerator: function(){
  ...
  return Object.keys(this.props.students).map(function(value){
    ...
    ,
      ...
      (React.createElement(CompareRow, {students: this.props.students[value], 
        input_display_arr: this.props.input_display_arr, 
  ...
  compare: function(){
    ...
    return Object.values(this.props.input_display_arr).map(function(subject_name){
      ...
      if(['maths', 'physics', 'chemistry'].includes(subject_name)){
        return (React.createElement("td", null, compare_marks))
      }
...
var TotalRow = React.createClass({displayName: "TotalRow",
  getInitialState: function(){
    ...
    addMaths: function(value){
      ...
      {debugger}
      return (React.createElement("td", null, this.state.maths_total));
    ...
    addPhysics: function(value){
      ...
      {debugger}
      return (React.createElement("td", null, this.state.physics_total));
    ...
    addChemistry: function(value){
      ...
      {debugger}
      return (React.createElement("td", null, this.state.chemistry_total));
